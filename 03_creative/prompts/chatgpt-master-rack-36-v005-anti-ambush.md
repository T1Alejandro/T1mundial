# Prompt maestro rack 36 tomas — v005 anti-ambush escolar
...
* Todos los dispositivos — smartphone, tablet, laptop — muestran pantalla blanca limpia, completamente en blanco, sin contenido, sin iconos, sin texto, sin UI, sin graficos de ningun tipo.
* El dispositivo es reconocible como objeto, la pantalla esta totalmente en blanco para post.
* No mostrar television con partido ni transmision deportiva. Si hay TV, debe estar fuera de cuadro o desenfocada con luces abstractas irreconocibles.
...
* Composicion centrada y simetrica que rima visualmente con la toma 02.
* Luz dorada entrando desde abajo, textura metalica como protagonista.
...
* Mochila roja #DA3B2B como protagonista, contraste fuerte con entorno neutro.
* Vestimenta completamente negra excepto la mochila roja.
* Encuadre medio trasero, centrado, lineas de escaleras como guia.
* Muros laterales generan simetria y direccion.
* Iluminacion de ocaso/crepusculo, cielo en tonos naranja oscuro y azul profundo.
...
07.
* Transicion cinematografica tipo wipe organico.
* Camara a media altura, a la altura del pecho de la figura.
* Silueta oscura de una persona o mochila pasando frente a camara ocupa el 95% del encuadre, barriendo de izquierda a derecha.
* El cuerpo en silueta tapa casi toda la imagen; solo un destello de contraluz calido de escuela/ciudad escapa por los bordes.
* Punto de ruptura visual entre escuela, ciudad y comercio.

08.
* Vendedora mexicana de mercado, unos 45 anos, en puesto de frutas y verduras.
* Encuadre lateral, camara desde el lado en perfil.
* Cliente acerca smartphone vertical a terminal generica de pago contactless en primer plano lateral.
* Manos, terminal y smartphone como punto de accion.
* Fondo vivo con familias y personas comprando, ropa cotidiana, desenfocado.
...
14.
* Hombre o mujer cerrando caja de ecommerce con cinta adhesiva blanca.
* Macro de manos, carton y etiqueta generica sin texto.
* Pequena bodega/taller mexicano, luz mixta fria funcional y ventana suave.
...
* Otros ninos desenfocados al fondo, esperando.
* Tono nerd/freaky, humano y encantador.

17.
* Mujer mexicana emprendedora revisando laptop en over-the-shoulder shot desde el hombro derecho.
* La laptop queda en el mismo plano y posicion que los dispositivos de tomas cercanas.
* Pantalla de laptop blanca limpia, completamente en blanco.
* Mesa llena de productos de su propio emprendimiento: skincare, perfumes, joyeria fina, accesorios o prendas.
* Todo el entorno comunica negocio propio: productos, espacio, control.
* Maceta roja #DA3B2B en tercer plano.
...
* Hombre de unos 24 anos gestionando ventas desde smartphone vertical en over-the-shoulder shot.
* Pantalla blanca limpia, completamente en blanco.
* Familia o clientes saliendo al fondo, luz calida de tarde entrando por la entrada del local.
* Capas de profundidad: stand de sneakers, gorras, cajas, calle de fondo.
...
* Al fondo: pasillo, cortina metalica o almacen escolar desenfocado, no red.
...
* Confeti escolar minimo o papeles de colores muy sutiles, no evento masivo.
...
* Destellos de luces calidas, realismo magico sobrio.
* Composicion amplia e inmersiva, no caotica.

35.
* Mexico sugerido desde arriba de noche, no como mapa literal.
* La forma general del territorio se intuye poeticamente por constelaciones de luces calidas de negocios, calles y pequenos comercios.
* Sin fronteras, sin lineas politicas, sin labels, sin pines, sin interfaz satelital, sin bandera.
* Sensacion de constelacion invertida: miles de puntos de actividad humana sosteniendo una geografia emocional.
* Emocional, vasto, abstracto pero reconocible solo por insinuacion.

36.
* Frame final minimal, casi negro, con red abstracta de luces comerciales sobre fondo oscuro.
* Composicion sobria y simetrica, espacio limpio para logo T1 y frase final en post.
* Sensacion premium, abstracta y emocional.
* No planeta literal si parece evento global; no poster patriotico ni imagen satelital informativa.
* Sin texto visible, sin logo generado por AI.
