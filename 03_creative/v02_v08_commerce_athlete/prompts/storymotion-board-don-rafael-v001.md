# Storymotion Board — Don Rafael v001

## Rutas

Ficha de personaje de referencia:

`07_assets/characters/model-sheets v02/don-rafael_model-sheet_v001.png`

Carpeta sugerida para guardar el tablero:

`07_assets/characters/storytime-motion-boards v02/`

Nombre sugerido del output:

`don-rafael_tablero-storyboard_v001.png`

## Para Qué Sirve

Este archivo es el paso ANTES de Seedance.

Primero se genera una plancha de storyboard para entender:

- puesta en escena,
- recorrido real de Don Rafael dentro del local,
- eje de acción,
...
Después de aprobar este tablero, elegimos 1-3 paneles y los usamos como fotogramas clave / guías para Seedance.

## Prompt Pegable — Storyboard Profesional Don Rafael

```text
Crea UNA imagen horizontal 16:9 tipo storyboard cinematográfico profesional para Don Rafael, personaje del hero film T1 v08: "El atleta del comercio mexicano".

Usa la ficha de personaje adjunta como referencia estricta de identidad. Mantén el mismo rostro, edad, pelo entrecano, barba gris recortada, complexión, manos, camisa azul marino oscuro, pantalón gris oscuro, zapatos negros limpios y acentos rojos discretos. Don Rafael debe ser el mismo hombre en todos los paneles.

OBJETIVO:
Crear una plancha de storyboard real para dirección de cine. No debe ser moodboard, no debe ser ficha de personaje, no debe ser análisis de props, no debe ser collage de stills bonitos. Debe servir para entender staging, blocking, recorrido físico, eje, continuidad espacial, posición de cámara, movimiento del personaje, movimiento de cámara y cortes entre tomas.

FORMATO:
Imagen completa horizontal 16:9.
Cuadrícula limpia de 4 columnas x 3 filas = 12 paneles.
Todos los paneles del mismo tamaño.
Cada panel debe sentirse como un encuadre cinematográfico 16:9 dentro de su celda. Si la celda lo necesita, usar aire/margen interno discreto para conservar proporción 16:9.
Lectura de izquierda a derecha y de arriba hacia abajo.
Sin cuadro hero grande.
Sin panel dominante.
Sin texto técnico debajo de los paneles.
Sin captions largas.
Sin etiquetas decorativas.
Números pequeños 01-12 permitidos si son discretos.
Flechas o líneas de movimiento permitidas solo si son limpias y ayudan a leer la acción. Si ensucian la imagen, omitirlas. La narrativa debe entenderse principalmente por puesta en escena, posición corporal, encuadre y continuidad.

TECHNICAL LOCKS:
locked floor plan.
fixed geography.
same shop layout across all 12 panels.
screen direction continuity.
no prop teleporting.
no object position changes unless physically moved by Don Rafael's hands.
objects do not move by themselves.
camera changes position logically around the same real shop.

GEOGRAFÍA FIJA DEL LOCAL:
La cortina metálica / entrada está al frente del local.
El mostrador está dentro del local y permanece siempre del mismo lado.
...
PANEL 04 — INTERIOR REVELADO:
Plano medio exterior desde atrás de Don Rafael, lente 35mm. La cortina está a media altura y Don Rafael todavía está afuera o justo en el umbral, de espaldas a cámara, terminando de abrir desde el lado de la calle. El interior empieza a verse a través de la apertura: mostrador al fondo o hacia un lado definido, estantes laterales/fondo, luz cálida entrando desde la calle. Este panel fija la geografía antes de entrar. No mostrarlo de frente ni dentro del local todavía.

PANEL 05 — SOBRE HOMBRO EN EL UMBRAL:
Plano sobre hombro derecho desde detrás de Don Rafael, lente 35mm. Él está en el umbral mirando hacia el interior. El mostrador se ve adelante en posición fija. Los estantes coinciden con el panel 04. Este panel inicia la dirección de pantalla hacia adentro.

PANEL 06 — PIES CRUZAN EL UMBRAL:
Plano bajo de pies, lente 50mm. Sus zapatos negros cruzan de exterior a interior sobre un umbral limpio. La luz cálida queda detrás y se proyecta en el piso. Empalme por movimiento desde el panel 05.

PANEL 07 — RUTA INTERIOR COMPLETA:
Plano abierto interior, lente 35mm. Don Rafael ya está dentro y camina desde la entrada hacia el mostrador. La entrada/cortina queda detrás o al mismo lado coherente. El mostrador queda adelante en la misma posición establecida. Se entiende la ruta real.

PANEL 08 — CAMINA JUNTO AL MOSTRADOR:
...
REGLAS DE DIRECCIÓN:
Cada panel debe tener una sola acción clara.
La secuencia debe respetar el recorrido físico real.
Mantener eje: exterior -> umbral -> interior -> mostrador.
No repetir encuadres sin cambio narrativo.
No crear retratos genéricos.
...
LOOK:
Cine independiente mexicano contemporáneo. Sobrio, elegante, humano, premium-real. Fotografía suave, contraste medio, negros ligeramente levantados, altas luces con roll-off analógico, grano fino cinematográfico, textura real de piel, lentes 35mm/50mm con insertos macro, profundidad de campo media a reducida.

PALETA:
Dorado amanecer, ámbar suave, terracota suave, ocres nobles, marrones cálidos, blancos cremosos, negro suave. Rojo T1 #DA3B2B solo como acento natural y controlado: trapo rojo, clip rojo de pluma, costura roja mínima. Sin verde dominante, sin tricolor, sin azul-blanco-rojo.
...
| Panel | Plano | Cámara | Acción | Continuidad |
|---:|---|---|---|---|
| 01 | Exterior frontal bajo | 35mm baja | Espera frente a cortina cerrada | Define fachada/entrada |
| 02 | Inserto manos | 50mm baja | Agarra barra | Misma cortina |
| 03 | Plano medio frontal bajo | 35mm baja | Cortina empieza a subir | Misma fachada/eje |
| 04 | Plano medio frontal | 35mm | Cortina a media altura, interior visible | Define mostrador/estantes |
| 05 | Sobre hombro derecho | 35mm seguimiento | Mira/entra desde umbral | Mostrador visible al fondo |
| 06 | Plano bajo de pies | 50mm baja | Cruza umbral | Empalme por movimiento |
| 07 | Plano abierto interior | 35mm | Camina hacia mostrador | Ruta real visible |
| 08 | Plano medio lateral | 35/50mm paneo | Sigue caminando al mostrador | Misma dirección de pantalla |
| 09 | Plano medio mostrador | 50mm | Llega, mano va a terminal | Terminal/props visibles |
| 10 | Macro manos | 100mm | Coloca terminal | Objeto movido físicamente |
| 11 | Macro props | 100mm | Alinea libreta/pluma/trapo | Terminal permanece fija |
| 12 | Plano medio cerrado | 50mm acercamiento | Mira tienda lista | Props finales fijos |

## Después De Aprobar

Elegir 1-3 paneles para fotogramas clave:

- Panel 04: cortina a media altura con interior revelado.
- Panel 05/07: entrada y recorrido espacial claro.
- Panel 10/11: terminal/libreta/trapo colocados físicamente.

Con esos fotogramas clave se pasa a Seedance / imagen a video.
